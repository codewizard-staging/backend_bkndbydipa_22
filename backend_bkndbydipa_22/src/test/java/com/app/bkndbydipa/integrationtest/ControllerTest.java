package com.app.bkndbydipa.integrationtest;
...
import com.app.bkndbydipa.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("bkndbydipa", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydipa/Organizations?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/bkndbydipa/Organizations/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmployeePersonalInfoInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydipa/EmployeePersonalInfoes")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydipa/EmployeePersonalInfoes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/bkndbydipa/EmployeePersonalInfoes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmlpoyeeProfileInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydipa/EmlpoyeeProfiles")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydipa/EmlpoyeeProfiles?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/bkndbydipa/EmlpoyeeProfiles/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM bkndbydipa.Organization");
    jdbcTemplate.execute("DELETE FROM bkndbydipa.EmployeePersonalInfo");
    jdbcTemplate.execute("DELETE FROM bkndbydipa.EmlpoyeeProfile");
